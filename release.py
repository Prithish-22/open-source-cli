...
def bump_version(old_ver: str, new_ver: str):
    ...
    print("  [OK] Updated tui/updater.py")
...
def main():
    ...
    if status.stdout.strip():
        print("WARNING: You have uncommitted files in your git repository.")
    ...
    try:
        ...
        print("  [OK] Pushed main branch and tags to GitHub successfully!")

        print("\nSUCCESS: Version bump complete & pushed to GitHub!")
        print("-" * 60)
